...
<body>
	...
	<div class="container">
		...
		<main class="main">
			...
			<div class="detail">
				<form action="<?php echo base_url('Admin/insertProduct') ?>" method="post" enctype="multipart/form-data" class="form">
					<div class="form-product">
						<div class="form-product-col">
							<p>
								<span>Tên sản phẩm</span>
								<input type="text" name="name" autofocus required class="required">
							</p>
							<p>
								<span>Mặt kính</span>
								<input type="text" name="glass" required class="required">
							</p>
							<p>
								<span>Đường kính mặt</span>
								<input type="text" name="diameter" required class="required">
							</p>
							<p>
								<span>Độ dày</span>
								<input type="text" name="thickness" required class="required">
							</p>
							<p>
								<span>Chống nước</span>
								<input type="text" name="waterproof" required class="required">
							</p>
							<p>
								<span>Bảo hành</span>
								<input type="text" name="guarantee" required class="required">
							</p>
							<p>
								<span>Giá</span>
								<input type="text" name="price" required class="required">
							</p>
							<p>
						...
						<div class="form-product-col">
							<div class="product-image">
								<img src="" alt="Ảnh sản phẩm" id="preview">
							</div>
							<input type="file" name="image_new" id="image_new" required>
						</div>
					</div>
					<div class="form-submit">
						<input type="submit" value="Lưu" name="submit" id="inp-add">
						<a href="./">Hủy</a>
					</div>
				</form>
			</div>
	...
	<script>
		window.addEventListener('load', function(e) {
			function previewFile() {
				...
				var file    = document.getElementById('image_new').files[0];
			...
			document.getElementById('image_new').addEventListener('change', function(e) {
				previewFile();
			});
			...
			document.getElementById('image_new').addEventListener('invalid', function(e) {
				this.setCustomValidity('cần có ảnh');
			});
			document.getElementById('image_new').addEventListener('input', function(e) {
				this.setCustomValidity('');
			});
		});
	</script>
